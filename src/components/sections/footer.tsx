            ...
            <ul className="mt-7 space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-[14px] text-white/60 transition-colors hover:text-brand-300"
                >
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
            {site.socials.map((s) => (
              <a
                ...
                className="group flex items-center gap-1 text-[13px] font-medium text-white/50 transition-colors hover:text-brand-300"
              >
                {s.label}
...
function FooterCol({
  ...
  return (
    <div>
      <h3 className="font-display text-[12px] font-bold uppercase tracking-[0.16em] text-white/40">
        {title}
      </h3>
      <ul className="mt-5 space-y-3">
        {links.map((l) => (
          <li key={l.label + l.href}>
            <a
              href={l.href}
              className="text-[14px] text-white/60 transition-colors hover:text-brand-300"
            >
              {l.label}
            </a>
          </li>
